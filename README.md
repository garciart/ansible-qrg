...
21. [perform_math.yml](perform_math.yml)
22. [demo_order_of_ops.yml](demo_order_of_ops.yml)
23. [check_equality.yml](check_equality.yml)
24. [check_identity.yml](check_identity.yml)
25. [use_conditionals.yml](use_conditionals.yml)
26. [combine_conditionals.yml](combine_conditionals.yml)
